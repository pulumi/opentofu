...
import (
	...
	fileprovisioner "github.com/pulumi/opentofu/builtin/provisioners/file"
	localexec "github.com/pulumi/opentofu/builtin/provisioners/local-exec"
	remoteexec "github.com/pulumi/opentofu/builtin/provisioners/remote-exec"
	"github.com/pulumi/opentofu/logging"
	tfplugin "github.com/pulumi/opentofu/plugin"
	"github.com/pulumi/opentofu/plugin/discovery"
	"github.com/pulumi/opentofu/provisioners"
)
