...
import (
	...
	"github.com/pulumi/opentofu/command/cliconfig/svcauthconfig"
	oauthserver "github.com/pulumi/opentofu/command/testdata/login-oauth-server"
	tfeserver "github.com/pulumi/opentofu/command/testdata/login-tfe-server"
