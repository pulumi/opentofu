...
func (d *evaluationStateData) GetOutput(addr addrs.OutputValue, rng tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics) {
	...
	// If the output is null - it does not serialize as part of the node_output state https://github.com/pulumi/opentofu/blob/4b623c56ffe9e6c1dc345e54470b71b0f261297a/tofu/node_output.go#L592-L596
