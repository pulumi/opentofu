...
import (
	...
	"github.com/pulumi/opentofu/backend"
	"github.com/pulumi/opentofu/encryption"
	"github.com/pulumi/opentofu/tfdiags"
	"github.com/zclconf/go-cty/cty"

	backendLocal "github.com/pulumi/opentofu/backend/local"
	backendRemote "github.com/pulumi/opentofu/backend/remote"
	backendAzure "github.com/pulumi/opentofu/backend/remote-state/azure"
	backendConsul "github.com/pulumi/opentofu/backend/remote-state/consul"
	backendCos "github.com/pulumi/opentofu/backend/remote-state/cos"
	backendGCS "github.com/pulumi/opentofu/backend/remote-state/gcs"
	backendHTTP "github.com/pulumi/opentofu/backend/remote-state/http"
	backendInmem "github.com/pulumi/opentofu/backend/remote-state/inmem"
	backendKubernetes "github.com/pulumi/opentofu/backend/remote-state/kubernetes"
	backendOSS "github.com/pulumi/opentofu/backend/remote-state/oss"
	backendPg "github.com/pulumi/opentofu/backend/remote-state/pg"
	backendS3 "github.com/pulumi/opentofu/backend/remote-state/s3"
	backendCloud "github.com/pulumi/opentofu/cloud"
)
