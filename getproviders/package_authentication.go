...
import (
	...
	"github.com/pulumi/opentofu/collections"
)
...
// refer to:
//
//	https://github.com/pulumi/opentofu/issues/266
//
...
func (s signatureAuthentication) AuthenticatePackage(location PackageLocation) (*PackageAuthenticationResult, error) {
	...
	if shouldValidate {
		...
		log.Printf("[WARN] Skipping GPG validation of provider package %s as no keys were provided by the registry. See https://github.com/pulumi/opentofu/pull/309 for more information.", location)
	}
